...
<head>
    ...
    <title>iFamily Card - Edited Penduduk</title>
    ...
    <div class="main-content">
        ...
        <main>
          <div class="card">
            ...
            <div class="card-body">
              <form name="formAgama" action="/penduduk/{{ $penduduk->id }}" method="post" onsubmit="return validateForm()">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label>NIK</label>
                    <input type="text" name="nik" id="nik" placeholder="NIK" class="form-control" value="{{ $penduduk->nik }}">
                  </div>
                  <div class="form-group">
                    <label>Nama Penduduk</label>
                    <input type="text" name="nama" id="nama" placeholder="Nama Penduduk" class="form-control" value="{{ $penduduk->nama }}">
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <input type="text" name="alamat" id="alamat" placeholder="Alamat Penduduk" class="form-control" value="{{ $penduduk->alamat }}">
                  </div>
                  <div class="form-group">
                    <label>Tanggal Lahir</label>
                    <input type="date" name="lahir" id="lahir" placeholder="Tanggal Lahir" class="form-control" lahir value="{{ $penduduk->lahir }}">
                  </div>
                  <div class="form-group">
