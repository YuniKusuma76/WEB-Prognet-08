...
<body>
  ...
  {{-- Start Sidebar --}}
    <div class="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="/anggotakk" class="active"><span class="las la-users"></span>
  ...
  {{-- Start List --}}
    <div class="main-content">
        ...
        <main>
          <div class="container">
            <h1>List Anggota Kartu Keluarga</h1>
              ...
              <tr class="tbody">
                ...
                @foreach ($data as $anggotakk)
                  <tr>
                    ...
                    <td>
                      <form action="/anggotakk/{{ $anggotakk->id }}/edit" method="GET">
                        <button class="btn btn-warning">Edit</button>
                      </form>
                      <form action="/anggotakk/{{ $anggotakk->id }}" method="POST" class="d-inline">
                        @method('delete')
                        @csrf
