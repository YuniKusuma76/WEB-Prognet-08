...
<head>
    ...
    <title>iFamily Card - Edited Hubungan Kartu Keluarga</title>
    ...
    <div class="main-content">
        ...
        <main>
          <div class="card">
            ...
            <div class="card-body">
              <form name="formHubungankk" action="/hubungankk/{{ $hubungankk->id }}" method="post" onsubmit="return validateForm()">
                @csrf
                @method('PUT')
                  <div class="form-group">
                    <label>Hubungan Kartu Keluarga</label>
                    <input type="text" name="hubungankk" id="hubungankk" placeholder="Hubungan Kartu Keluarga" class="form-control" value="{{ $hubungankk->hubungankk }}">
                  </div>
                  <div>
          ...
          <script>
            function validateForm() {
              // Validasi Hubungankk
              if (document.forms["formHubungankk"]["hubungankk"].value == "") {
                  alert("Anda belum memasukkan Hubungan Kartu Keluarga Anda");
                  document.forms["formHubungankk"]["hubungankk"].focus();
                  return false;
              }
            }
        </script>
